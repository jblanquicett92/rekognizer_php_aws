                        ...
                        <table class="table table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php print (empty($result['FaceDetails'][$n]['Eyeglasses']['Value'])?"False":"True") ; ?></td>
                                    <td><?php print $result['FaceDetails'][$n]['Eyeglasses']['Confidence'] . " %"; ?></td>
                                </tr>
                                <tr>
                                    <td><?php print  "Smile" ?></td>
                                    <td><?php print (empty($result['FaceDetails'][$n]['Smile']['Value'])?"False":"True") ; ?></td>
                                    <td><?php print $result['FaceDetails'][$n]['Smile']['Confidence'] . " %"; ?></td>
                                </tr>
                                <tr>
                                    <td><?php print  "EyesOpen" ?></td>
                                    <td><?php print (empty($result['FaceDetails'][$n]['EyesOpen']['Value'])?"False":"True") ; ?></td>
                                    <td><?php print $result['FaceDetails'][$n]['EyesOpen']['Confidence'] . " %"; ?></td>
                                </tr>
                                <tr>
                                    <td><?php print  "MouthOpen" ?></td>
                                    <td><?php print (empty($result['FaceDetails'][$n]['MouthOpen']['Value'])?"False":"True") ; ?></td>
